    ...
    withHandlers({
      initAmplitude: props => async () => {
        try{
          ...
          alert("Network Error");
          console.log("initAmplitude error", error);
        }
      },
      /**
      ...
      initSentry: props => async () => {
        try {
          ...
          console.log("initSentry error", error);
        }
      },
      cacheResourcesAsync: props => async () => {
        try {
          ...
          console.log("cacheResourcesAsync error", error);
        }
      },
      initAppVariables: props => async () => {
        try {
          ...
          console.log("initAppVariables error", error);
        }
      },
    }),
    lifecycle({
